...
const AddDonorInfo = (props) => {
    ...
    return (
        <div >
            <center>
                <Card style={{ width: '48rem',backgroundColor:'#FFA843' }} >
                    ...
                    <Card.Body>
                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Form.Group controlId="donorName">
                                <Form.Label style={{ color:'#fff' }}>Donor Name</Form.Label>
                            ...
                            <Form.Group controlId="donorLocation">
                                <Form.Label style={{ color:'#fff' }}>Donor Location</Form.Label>
                            ...
                            <Form.Group controlId="donorFoodCategory">
                                <Form.Label style={{ color:'#fff' }}>Food Category</Form.Label>
                            ...
                            <Form.Group controlId="donorQuantityAvailable">
                                <Form.Label style={{ color:'#fff' }}>Quantity Available</Form.Label>
                            ...
                            <Form.Group controlId="donorFoodDetails">
                                <Form.Label style={{ color:'#fff' }}>Additional Details</Form.Label>
                            ...
                            <Form.Group controlId="donorContactEmail">
                                <Form.Label style={{ color:'#fff' }}>Donor Email</Form.Label>
